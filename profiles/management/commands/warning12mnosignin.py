...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ### Get the queryset ###
        referencedate = timezone.now() - timedelta(weeks=52)
        ...
        main_message_profiles_inactive = 'Successfully sent a warning email to profiles that did not sign in in the past 12 months. Emails sent to: ' + profiles_inactive_list
        main_message_no_profiles_inactive = 'All the profiles have at least 1 connection in the past 12 months or are already informed by mail. No email sent.'
